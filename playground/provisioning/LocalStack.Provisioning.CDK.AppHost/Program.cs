...
// var cdkBootstrap = builder.AddAWSCDKBootstrapCloudFormationTemplateForLocalStack(localstack)
...
// Manual mode may add WithReference(localstack) and WaitFor(cdkBootstrap!) before WithReference(awsConfig).
...
// Manual mode may add WithReference(localstack) before the WithEnvironment calls.
